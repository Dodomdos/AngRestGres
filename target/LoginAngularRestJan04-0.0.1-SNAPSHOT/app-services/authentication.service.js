(function () {
    ...
    function AuthenticationService(UserService,$http, $cookies, $rootScope) {
        ...
        function GetCredentials($rootScope,callback) {
            
          (function () {
          	
            	$rootScope.user = $cookies.get('globals'); 
            	console.log('username getcredential '+ $rootScope.user);
            	//$rootScope.currUser = [];
            	
            	angular.forEach($rootScope.user.currentUser, function (value,key) {
        ...
        function SetCredentials(user) {
            ...
            console.log('Inside SetCredentials '+$rootScope.globals.currentUser.username);
